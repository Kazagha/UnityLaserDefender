...
public class Player : MonoBehaviour {
	...
	void Start () {
		...
		Vector3 thrustPos = this.transform.position + new Vector3(0, -0.4f , 0f);
		GameObject thrust = Instantiate(PlayerThruster, thrustPos, Quaternion.Euler(90, 0, 0)) as GameObject;
